  	...
  	<section id="all-job">
        <div class="container" style="border:0px solid red;">
			...
			<div class="col-sm-4" style="border:0px solid green;text-align:center;margin-bottom:0px;">
				<!--<img style="margin-bottom:10px;border:1px solid black;" src="<?php echo site_url();?>images/adimage/290.png" />
				<img style="margin-bottom:10px;border:1px solid black;" src="<?php echo site_url();?>images/adimage/290.png" />
				<img style="margin-bottom:10px;border:1px solid black;" src="<?php echo site_url();?>images/adimage/290.png" />
				<img style="margin-bottom:10px;border:1px solid black;"src="<?php echo site_url();?>images/adimage/290.png" />
			...
			<div class="col-sm-8" style="border:0px solid red;text-align:center;margin-bottom:0px;">
