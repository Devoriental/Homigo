...
<div class="row">
	<div class="eight columns">
		...
		<form action="<?php echo site_url();?>bosslog_user/edituser/<?php echo $arr['advertise_id'];?>.html" method="post">
			<!--<h4 style="color:blue">Additional Information</h4>-->

				<table class='u-full-width'>
					<tr><td><label class="">Company:</label></td>
						<td><input type="text" name="user_name" value="<?php echo $arr['company'];?>"></td>
					</tr>
