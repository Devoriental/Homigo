		...
		<div class="row">
			<div class="col-sm-8">
				<?php if($arr['photo']!=''){?>
					...
					<br> 
				<?php }?>
				<form action="<?php echo site_url()?>companyprofile/photo.html" method="post" enctype="multipart/form-data">		
					
					<p>Upload/update your logo.</p><br> 
					
					<input type="file" name="userfile">
					<input type="submit" name="sb" class="btn btn-primary btn-lg" value="Submit"><br>	<br>	
					<p>
						<ul style="list-style-type:disc;margin-left:15px;">
							<li>Photo width maximum 200 pixel</li>
							<li>Photo height maximum 200 pixel</li>
